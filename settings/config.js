...
module.exports.config = {
    settings: {
        token: 'ODQ4MzYxMzcwOTM2Mjc5MDUx.YLLgGA.XKR0wKmAueU14UuUO6WqjAVnwYc',
        prefix: '.',
        mentionPrefix: true, //Whether the bot has a mention prefix
        // client.user.setPresence({ activity: { name: 'with Kudi!' }, status: 'dnd' })
        botActivity: {
            status: 'dnd',
            activity: {
                name: 'With Kudi!',
        ...
        changingActivity: { //An activity that automatically updates
            enabled: false,
            activities: ['music', 'Spotify','you take a shower'],
            types: ['Listening'],
        },
        embedColor: 'BLUE',
        GuildID: '859465848338907136',
        BotOwnerDiscordID: '715478419592446063',
        EpicGamesUUID: '744030204342567007',
    },
    automod: {
        // - - - BANNED STUFF - - -
        ...
        // - - - CAPS SPAM - - -
        Caps_Limit: '', //percentage of caps that users can type (leave blank to disable)
        ...
        Bypass_Caps_Roles: [`862998725861703701`], //has to be a role ik im dumb
    ...
    moderation: {
        Moderators: [859490051670147102,859489952881836032,859489711713026139], //roles that can use any moderation command
        serverLock: true, //whether or not to enable the server lock command
        Mute_Role: '863009696402636821'
    },
    automation: {
        ...
        Invite_Link: 'https://discord.gg/fave',
    ...
    verification: {
        ...
        verifyChannel: '859465956401348608', //leave blank for use in any channel
        verifyRole: '861030196378730507',
    ...
    music: {
        ...
        DJrole: '848362186204250122', //By default djs can use all music commands
        user_DJs: [], //Users that can use dj commands (USER IDS ONLY)
        Disabled_DJ_Commands: [''], //Commands DJS cant use
    ...
    logging: {
        Report_Channel: '862088617853583390',
        Ban_Channel_Logs: '859482712607555636',
        Unban_Channel_Logs: '859482712607555636',
        Kick_Channel_Logs: '859482712607555636',
        Warn_Channel_Logs: '859482712607555636',
        Mute_Channel_Logs: '859482712607555636',
        Lock_Channel_Logs: '859482712607555636',
        Ticket_Channel_Logs: '859482712607555636',
        Moderation_Channel_Logs: '859482712607555636',
        Suggestion_Channel_Logs: '864043192164548660',
        Report_Channel_Logs: '859482712607555636',
        Server_Updates: '859482712607555636',
        Voice_Updates: '859482712607555636',
        Role_Updates: '859482712607555636',
        Channel_Updates: '859482712607555636',
        Message_Updates: '859482712607555636',
    },
    starBoard: {
        Enabled: false,
    ...
    applicationSystem: {
        applications: [{
                ...
                Application_Log: '848363593384460339', //Where to send completed apps
                Application_Name: 'Really Good application!', //application name (must be unique)
                Application_Channel: '848363858727796746', //The channel where people can apply in (leave blank for any)
                questions: ['What are ya gonna do,cry?', 'piss your pants?', 'ij'] //questions this application will ask
            },
            {
                enabled: true, //whether to enable or disable this application
    ...
    welcomeSystem: {
        enabled: true,
        welcomeChannel: '859479162787987507',
        welcomeType: 'embed', //select from these 4 options -> message, embed, dm or card!
        welcomeCardBackGroundURL: 'https://cdn.discordapp.com/attachments/859479162787987507/864051003741044736/images1.jpeg',
