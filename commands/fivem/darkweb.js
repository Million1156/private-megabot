...
module.exports.run = async(client, message, args) => {
    let embed4 = new client.embed().setDescription(`What is your darkweb posting or message?`).setFooter(`${message.guild.name} | Made By dreamwastaken#0001`, message.guild.iconURL({ dynamic: true }))
