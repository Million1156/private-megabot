...
module.exports.run = async(client, message, args) => {
    const embed1 = new client.embed().setDescription(`Sorry! This server did not setup the verification role yet!`).setFooter(`${message.guild.name} | Made by dreamwastaken#0001`, message.guild.iconURL({ dynamic: true }))
    const embed2 = new client.embed().setDescription(`Sorry! You are already verified!`).setFooter(`${message.guild.name} | Made by dreamwastaken#0001`, message.guild.iconURL({ dynamic: true }))
    ...
    if (vSettings.verificationType === 'captcha') {
        const embed3 = new client.embed().setDescription(`Sorry! You are already started the verification process in your dms!`).setFooter(`${message.guild.name} | Made by dreamwastaken#0001`, message.guild.iconURL({ dynamic: true }))
