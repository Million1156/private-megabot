...
module.exports.run = async(client, message, args) => {
    ...
    try {
        ...
        message.channel.send(new client.embed().setDescription('Please provide me an equation.').setFooter(`${message.guild.name} | Made By dreamwastaken#0001`, message.guild.iconURL({ dynamic: true })))
    }
}