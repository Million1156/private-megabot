...
module.exports.run = async(client, message, args) => {
    ...
    if (!reason[0]) return message.channel.send(new client.embed().setDescription('You need to enter what to remind you about!').setFooter(`${message.guild.name} | Made By dreamwastaken#0001`, message.guild.iconURL({ dynamic: true })))
