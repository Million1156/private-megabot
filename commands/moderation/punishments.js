...
module.exports.run = async(client, message, args) => {
    ...
    if (!member) return message.channel.send(new client.embed().setDescription(`Please specify a user to view punishments on.`).setFooter(`${message.guild.name} | Made By dreamwastaken#0001`, message.guild.iconURL({ dynamic: true })))
