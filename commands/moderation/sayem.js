...
module.exports.run = async(client, message, args) => {
    ...
    if (!say) return message.channel.send(new client.embed().setDescription(`You didn\'t provide any text for me to say!`).setFooter(`${message.guild.name} | Made By dreamwastaken#0001`, message.guild.iconURL({ dynamic: true })))
    message.delete()
