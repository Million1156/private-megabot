...
module.exports.run = async(client, message, args) => {
    ...
    message.author.send(new client.embed().setColor(`GREEN`).setDescription(`Success! You have unlocked ${channel.name}.`).setFooter(`${message.guild.name} | Made By dreamwastaken#0001`, message.guild.iconURL({ dynamic: true })))
}