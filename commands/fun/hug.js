...
module.exports.run = async(client, message, args) => {
    ...
    if (!gifs) {
        return message.channel.send(new client.embed().setDescription(`You need to mention who you would like to hug!`).setFooter(`${message.guild.name} | Made By dreamwastaken#0001`, message.guild.iconURL({ dynamic: true })))
    } else {
        let gifs = [
        ...
        var embed = new client.embed()
            ...
            .setImage(randomGif)
            .setFooter(`${message.author.tag} Needed A Hug!  |  Made By dreamwastaken#0001`, message.author.displayAvatarURL({ dynamic: true }))
            .setTimestamp()
