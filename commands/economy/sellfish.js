...
module.exports.run = async(client, message, args) => {
    ...
    if (!fish) return message.channel.send(new client.embed().setDescription(`You dont have any fish to sell! Go fish for some with \`${message.px}fish\``).setFooter(`${message.guild.name} | Made By dreamwastaken#0001`, message.guild.iconURL({ dynamic: true })))
