...
module.exports = async client => {
        ...
        console.log(`\x1b[34m` + "[Thank You] I thank you for purchasing the new bot, I hope you enjoy it!")
        console.log(`\x1b[35m` + "[Creator] Made By Project MegaBot")
        console.log(`\x1b[34m` + "[Support] If you require support you can go to www.example.com\x1b[0m")
